...
export function ListingCard({ product }: ListingCardProps) {
    return (
        <div className="flex flex-col overflow-hidden rounded-3xl border border-dark-200 bg-white dark:bg-card transition-all duration-300 hover:shadow-card hover:scale-[1.02]">
